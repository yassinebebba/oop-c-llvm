...
define void @"_ZN6Player6PlayerEPS_is"(%"class.Player"* %"this", i32 %"x", i16 %"y")
{
entry:
...
entry:
  ...
  call void @"_ZN6Player6PlayerEPS_is"(%"class.Player"* %"player", i32 1, i16 %".2")
  %"fmt" = alloca i8*
  ...
  %".8" = load i32, i32* %".7"
  %".9" = call i32 @"_ZN6Player4getxEPS_"(%"class.Player"* %"player")
  %".10" = call i32 @"_ZN6Player4getyEPS_"(%"class.Player"* %"player")
  ...
  %".14" = load i32, i32* %".13"
  %".15" = add i32 %".12", %".14"
  %".16" = call i32 @"_ZN6Player4getxEPS_"(%"class.Player"* %"player")
  %".17" = call i32 @"_ZN6Player4getyEPS_"(%"class.Player"* %"player")
  %".18" = add i32 %".16", %".17"
  %".19" = load i8*, i8** %"fmt"
