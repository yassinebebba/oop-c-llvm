...
entry:
  ...
  %".4" = call i32 (i8*, ...) @"printf"(i8* getelementptr ([5 x i8], [5 x i8]* @".str.3", i64 0, i64 0))
  ...
  %".29" = getelementptr %"Player", %"Player"* %"player", i32 0, i32 4
  %".30" = load i8* (%"Player"*)*, i8* (%"Player"*)** %".29"
  %".31" = call i8* %".30"(%"Player"* %"player")
  %".32" = call i32 (i8*, ...) @"printf"(i8* getelementptr ([3 x i8], [3 x i8]* @".str.4", i64 0, i64 0), i8* %".31")
  ret i32 0
}
...
@".str.3" = private unnamed_addr constant [5 x i8] c"hey\0a\00"
