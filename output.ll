...
{
entry:
  %".5" = getelementptr %"class.Player", %"class.Player"* %"this", i32 0, i32 0
  store i32 %"x", i32* %".5"
  %".7" = getelementptr %"class.Player", %"class.Player"* %"this", i32 0, i32 1
  store i32 %"y", i32* %".7"
  ret void
}
...
entry:
  ...
  %".8" = getelementptr %"class.Player", %"class.Player"* %"player", i32 0, i32 0
  %".9" = load i32, i32* %".8"
  %".10" = getelementptr %"class.Player", %"class.Player"* %"player", i32 0, i32 1
  %".11" = load i32, i32* %".10"
  %".12" = call i32 @"_ZN6Player4getxEPS_"(%"class.Player"* %"player")
  %".13" = call i32 @"_ZN6Player4getyEPS_"(%"class.Player"* %"player")
  %".14" = getelementptr %"class.Player", %"class.Player"* %"player", i32 0, i32 0
  %".15" = load i32, i32* %".14"
  %".16" = getelementptr %"class.Player", %"class.Player"* %"player", i32 0, i32 1
  %".17" = load i32, i32* %".16"
  %".18" = add i32 %".15", %".17"
