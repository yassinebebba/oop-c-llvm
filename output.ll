...
define i32 @"_ZN7Point1D5get_yEPS_"(%"class.Point1D"* %"this")
{
entry:
  %".3" = getelementptr %"class.Point1D", %"class.Point1D"* %"this", i32 0, i32 0
  %".4" = load i32, i32* %".3"
...
entry:
  ...
  %".3" = call i32 @"_ZN7Point1D5get_xEPS_"(%"class.Point1D"* %"p1d")
  %".4" = call i32 (i8*, ...) @"printf"(i8* getelementptr ([16 x i8], [16 x i8]* @".str.1", i64 0, i64 0), i32 %".3")
  ret i32 0
}
